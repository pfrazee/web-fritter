...
const {toUrl, urlSlug, normalizeUrl, toDriveOrigin} = require('./util')
...
class LibFritterFeedAPI {
  ...
  async post (drive, {text, threadRoot, threadParent, mentions, createdAt}) {
